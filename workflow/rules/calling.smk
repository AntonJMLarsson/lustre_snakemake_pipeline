...
rule merge_concord_intervals_KNR:
    input: expand("results/KNR_concord_bed/{cell}.bed", cell=CELLS)
...
rule merge_concord_intervals_UNK:
    input: expand("results/UNK_concord_bed/{cell}.bed", cell=CELLS)
...
rule concat_concord_bam_KNR:
    input: expand("results/KNR_bam_concord/{cell}.bam", cell=CELLS)
...
rule concat_concord_bam_UNK:
    input: expand("results/UNK_bam_concord/{cell}.bam", cell=CELLS)
...
rule concat_discond_bam_KNR:
    input: expand("results/KNR_bam/{cell}.bam", cell=CELLS)
...
rule concat_discond_bam_UNK:
    input: expand("results/UNK_bam/{cell}.bam", cell=CELLS)
...
rule merge_KNR_intervals:
    input: expand("results/KNR_intervals_bed/{cell}.bed", cell=CELLS)
...
rule merge_UNK_intervals:
    input: expand("results/UNK_intervals_bed/{cell}.bed", cell=CELLS)

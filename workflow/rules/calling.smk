...
rule merge_concord_intervals_KNR:
    input: lambda wildcards:expand("results/KNR_concord_bed/{cell}.bed", cell=get_cells(wildcards).split('/')[-1].split('.')[0])
...
rule merge_concord_intervals_UNK:
    input: lambda wildcards:expand("results/UNK_concord_bed/{cell}.bed", cell=get_cells(wildcards).split('/')[-1].split('.')[0])
...
rule concat_concord_bam_KNR:
    input: lambda wildcards:expand("results/KNR_bam_concord/{cell}.bam", cell=get_cells(wildcards).split('/')[-1].split('.')[0])
...
rule concat_concord_bam_UNK:
    input: lambda wildcards:expand("results/UNK_bam_concord/{cell}.bam", cell=get_cells(wildcards).split('/')[-1].split('.')[0])
...
rule concat_discond_bam_KNR:
    input: lambda wildcards:expand("results/KNR_bam/{cell}.bam", cell=get_cells(wildcards).split('/')[-1].split('.')[0])
...
rule concat_discond_bam_UNK:
    input: lambda wildcards:expand("results/UNK_bam/{cell}.bam", cell=get_cells(wildcards).split('/')[-1].split('.')[0])
...
rule merge_KNR_intervals:
    input: lambda wildcards:expand("results/KNR_intervals_bed/{cell}.bed", cell=get_cells(wildcards).split('/')[-1].split('.')[0])
...
rule merge_UNK_intervals:
    input: lambda wildcards:expand("results/UNK_intervals_bed/{cell}.bed", cell=get_cells(wildcards).split('/')[-1].split('.')[0])

...
for donor in config["custom_references"].keys():
    rule:
        ...
        output: "results/insertion_tables/{project}_KNR_{donor}_insertion_table.csv"
        params: regular_stats = "results/regular_stats/{project}_KNR_{donor}_stats.csv", regular_read_mat = "results/regular_stats/{project}_KNR_{donor}_read_depth.csv",remapped_stats = "results/regular_stats/{project}_KNR_{donor}_stats.csv", remapped_read_mat = "results/regular_stats/{project}_KNR_{donor}_read_depth.csv" 
    ...
    rule:
        ...
        params: regular_stats = "results/regular_stats/{project}_UNK_{donor}_stats.csv" , regular_read_mat = "results/regular_stats/{project}_UNK_{donor}_read_depth.csv" ,remapped_stats = "results/regular_stats/{project}_UNK_{donor}_stats.csv" , remapped_read_mat = "results/regular_stats/{project}_UNK_{donor}_read_depth.csv"

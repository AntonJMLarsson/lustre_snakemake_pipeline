...
for donor in config["custom_references"].keys():
    ...
    rule:
        ...
        params: donor = donor, regular_stats = "results/regular_stats/{project}_UNK_{donor}_stats.csv".format(project=config["project"], donor=donor), regular_read_mat = "results/regular_stats/{project}_UNK_{donor}_read_depth.csv".format(project=config["project"], donor=donor), remapped_stats = "results/remapped_stats/{project}_UNK_{donor}_stats.csv".format(project=config["project"], donor=donor), remapped_read_mat = "results/regular_stats/{project}_UNK_{donor}_read_depth.csv".format(project=config["project"], donor=donor)

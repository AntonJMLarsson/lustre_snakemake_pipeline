...
rule split_files:
    input: "results/mapped_qname_filtered/{cell}"
    output:
        r1 = "results/mapped_qname_r1/{cell}",
        r2 = "results/mapped_qname_r2/{cell}"
    shell:

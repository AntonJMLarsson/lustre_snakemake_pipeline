...
rule count_cell_detection_KR:
    ...
    shell: "python3 workflow/scripts/count_cell_detection.py -bam {input.bam} -ins {config[KR_file]} -sample {config[samplesheet]} -p results/regular_stats/{config[project]}_KR -ct BC -t 50"
